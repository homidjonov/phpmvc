                      ...
                      '<div class="modal-dialog">' +
                        '<div class="modal-content">' +
                          ...
                          '<div class="modal-body">' +
                            '<div class="row-fluid">' +
                              '<div class="note-dropzone span12" style="display: none">Drag an image here</div><input class="note-image-input" id="note-image-input" type="file" style="display: none" name="files" multiple/><div class="input-group"><input class="note-image-url form-control span12" type="text" placeholder="Paste Image URL or Select File" /><span class="input-group-btn"><button class="btn btn-primary" type="button" onclick="$(\'#note-image-input\').click()">Browse</button></span></div>' +
                            '</div>' +
                          '</div>' +
